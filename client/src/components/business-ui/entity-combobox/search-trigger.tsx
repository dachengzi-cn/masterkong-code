  ...
  return (
    ...
    >
              ...
              renderTag ? (
                ...
                >
                  ...
                  {tagClosable && (
                    ...
                    >
                      <span className={`inline-flex items-center justify-center text-base leading-none ${tagCloseIconVariants({ size })}`}>❌</span>
                    </button>
                  )}
                </Badge>
              ),
      ...
      {selectedArray.length > 0 && (
        ...
        >
          <>
            <span className="inline-flex items-center justify-center text-base leading-none h-3! w-3!" >❌</span>
      ...
      <div className={cn('ml-1', classNames?.suffix)}>
        {open ? (
          <span className="inline-flex items-center justify-center text-base leading-none h-4 w-4 shrink-0 opacity-50" >▲</span>
        ) : (
          <span className="inline-flex items-center justify-center text-base leading-none h-4 w-4 shrink-0 opacity-50" >▼</span>
        )}
      </div>

...
export function ColorHighlightToolbarButton() {
  ...
  const trigger = (
    <Button
      ...
      disabled={disabled}
    >
      <span className="inline-flex items-center justify-center text-base leading-none" style={{ color: currentColor }} >🖊️</span>
            ...
            {TEXT_COLORS.map((color) => {
              ...
              return (
                ...
                >
                  ...
                  />
                  {isSelected && (
                    <span className="inline-flex items-center justify-center text-base leading-none absolute text-white" >✓</span>
                  )}
                </button>
              );
            })}
